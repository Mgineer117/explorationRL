...
gym.register(
    ...
    kwargs={
        ...
        "skrl_aga_zic_cfg_entry_point": f"{agents.__name__}:skrl_aga_zic_cfg.yaml",
        "skrl_pgnc_cfg_entry_point": f"{agents.__name__}:skrl_pgnc_cfg.yaml",
        "skrl_ppo_zic_cfg_entry_point": f"{agents.__name__}:skrl_ppo_zic_cfg.yaml",
